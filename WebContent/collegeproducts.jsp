...
<%
   ...
   List<Product> products = pd.getAllproductsCollege("college");
...
<head>
<meta charset="UTF-8">
<title>ThreadMuse- College wear</title>
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">College Wear</li>
                </ol>
            </nav>
            <h2 class=" fw-bold">College Wear</h2>
        </div>
    </div>
