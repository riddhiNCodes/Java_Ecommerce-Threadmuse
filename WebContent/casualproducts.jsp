...
<%
   ...
   List<Product> products = pd.getAllproductsCasual("casuals");
...
<head>
<meta charset="UTF-8">
<title>ThreadMuse- Casual wear</title>
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Casual Wear</li>
                </ol>
            </nav>
            <h2 class="fw-bold">Casual Wear</h2>
        </div>
    </div>
